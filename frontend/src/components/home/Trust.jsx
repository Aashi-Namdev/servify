...
function Trust() {
  return (
    <div className='
      ...
      w-[calc(100%_-_2rem)] sm:w-[90%] md:w-[60%] max-w-4xl
    ...
    '>
      ...
      <div className='flex flex-col items-center flex-1'>
        ...
        <p className='text-center text-xs md:text-sm text-blue-200'>Services Completed</p>
      </div>
      ...
      <div className='flex flex-col items-center flex-1'>
        ...
        <p className='text-center text-xs md:text-sm text-blue-200'>Happy Customers</p>
      </div>
      ...
      <div className='flex flex-col items-center flex-1'>
        ...
        <p className='text-center text-xs md:text-sm text-blue-200'>Verified Professionals</p>
      </div>
      ...
      <div className='flex flex-col items-center flex-1'>
        ...
        <p className='text-center text-xs md:text-sm text-blue-200'>Average Rating</p>
      </div>
