...
function HeroSection() {
  ...
  return (
    <div className="w-full relative mb-28 sm:mb-24 md:mb-20">
      <div className="relative min-h-[560px] sm:min-h-[620px] md:h-[90vh] w-full overflow-hidden">
        <img
          src={bg}
          alt="Hero background"
          loading="lazy"
        ...
        <div className="relative z-10 flex min-h-[560px] sm:min-h-[620px] md:h-full md:min-h-0 items-center justify-start px-4 sm:px-6 md:px-10 py-24 sm:py-28 md:py-0">
            ...
            >
              <div className="w-full relative flex items-center mt-2">
                <input
                  ...
                  type="text"
                  spellCheck="false"
                  className="w-full bg-black/20 border border-white/30 px-5 pr-[72px] sm:pr-20 backdrop-blur-md focus:outline-none transition-all focus:border-blue-400 hover:border-white/50 py-3 placeholder:text-gray-300 text-white text-sm rounded-full"
