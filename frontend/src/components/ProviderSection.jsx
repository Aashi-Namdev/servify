...
function ProviderSection() {
  ...
  return (
    <div className="w-full min-h-[70vh] flex items-center justify-center py-5 px-5">
      <div className="max-w-7xl mx-auto flex justify-between items-start w-full bg-[#0F2F66]   rounded-2xl pl-10 hover:shadow-2xl transition-shadow duration-300 border border-gray-100">
        <div>
          <h1 className="text-3xl font-bold text-gray-50  mb-2 mt-10">
            Become a Provider
          </h1>
          ...
          <div className="flex flex-col-reverse md:flex-row items-center w-full justify-between gap-10">
            <div className="flex flex-col gap-1 w-full ">
              <div className="flex items-center gap-3 p-3 rounded-xl hover:bg-blue-50/80 transition-colors duration-200 cursor-pointer group">
                <span className="w-8 h-8 rounded-full bg-blue-100 text-[#1E4ED8] flex items-center justify-center font-bold group-hover:bg-[#1E4ED8] group-hover:text-white transition-colors duration-200">
                  ✔
                </span>
                <p className="text-gray-300 font-medium group-hover:text-blue-900">
