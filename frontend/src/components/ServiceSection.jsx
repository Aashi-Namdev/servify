...
function ServiceSection() {
  ...
  //     description: "Professional home cleaning services by verified experts near you.",
  //     rating: "4.8",
  //     location: "Delhi",
  //     price: "499",
  //     tag: "Popular",
  ...
  //     price: "699",
  //     tag: "Trending",
  //     description: "Expert AC repair services to keep your system running smoothly.",
  //   },
  //   {
  ...
  //     price: "399",
  //     tag: "Top Rated",
  //     description: "Reliable plumbing services to fix all your water supply issues.",
  //   },
  //   {
  ...
  //     price: "299",
  //     tag: "Popular",
  //     description: "Professional electrician services for all your wiring and installation needs.",
  //   },
  // ];
