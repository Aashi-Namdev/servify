...
function Trust() {
  return (
    <div className=' flex items-center gap-7 px-7 py-3 absolute bottom-0 left-[50%] -translate-x-1/2 translate-y-1/2 rounded-2xl overflow-hidden bg-[#1E4ED8] h-28 min-w-[300px] shadow shadow-2xl z-20'>
